...
import com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.utils.timer.Hourglass;

public class SoundPlayerService extends Service {
    public static final String ACTION_CMD = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_CMD";
    public static final String ACTION_OPEN_FROM_NOTIFI = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_OPEN_FROM_NOTIFI";
    public static final String ACTION_UPDATE_BED = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_UPDATE_BED";
    public static final String ACTION_UPDATE_PLAY_STATE = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_UPDATE_PLAY_STATE";
    public static final String ACTION_UPDATE_SOUND_SELECTED = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_UPDATE_SOUND_SELECTED";
    public static final String ACTION_UPDATE_TIME = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ACTION_UPDATE_TIME";
    ...
    public static final String UPDATE_PLAY_STATE = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.UPDATE_PLAY_STATE";
    public static final String UPDATE_SOUND_SELECTED = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.UPDATE_SOUND_SELECTED";
    public static final String UPDATE_TIME = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.UPDATE_TIME";
    ...
    private void handlerPlayMix(Intent intent) {
        ModelMix modelMixById = SoundList.getMixItemById(intent.getIntExtra(MIX_ID, -1));
        ModelMix modelMix = this.soundPlayerManager.getMixItem();
        if (modelMixById == null || modelMix == null || modelMixById.getmMixSoundId() != modelMix.getmMixSoundId()) {
            handlerReleaseAll(intent);
            this.soundPlayerManager.setMixItem(modelMixById);
            for (ModelSound modelSound : modelMixById.getmSoundList()) {
                if (modelSound != null) {
                    this.soundPlayerManager.play(modelSound);
                }
            }
            handlerUpdateTime(intent);
        } else {
    ...
    private void handlerPause(Intent intent) {
        ModelSound modelSoundById = SoundList.getSoundItemById(intent.getIntExtra(SOUND_ID, -1));
        if (modelSoundById != null) {
            this.soundPlayerManager.pause(modelSoundById);
        }
    }
    ...
    private void handlerPlay(Intent intent) {
        ModelSound modelSoundById = SoundList.getSoundItemById(intent.getIntExtra(SOUND_ID, -1));
        if (modelSoundById != null) {
            this.soundPlayerManager.play(modelSoundById);
        }
        updateSoundSelect();
    }
    ...
    private void handlerRelease(Intent intent) {
        ModelSound modelSoundById = SoundList.getSoundItemById(intent.getIntExtra(SOUND_ID, -1));
        if (modelSoundById != null) {
            this.soundPlayerManager.release(modelSoundById);
        }
    }
    ...
    private void handlerResume(Intent intent) {
        ModelSound modelSoundById = SoundList.getSoundItemById(intent.getIntExtra(SOUND_ID, -1));
        if (modelSoundById != null) {
            this.soundPlayerManager.resume(modelSoundById);
        }
    }
    ...
    private void handlerStop(Intent intent) {
        ModelSound modelSoundById = SoundList.getSoundItemById(intent.getIntExtra(SOUND_ID, -1));
        if (modelSoundById != null) {
            this.soundPlayerManager.stop(modelSoundById);
        }
    }
    ...
    private String createNotificationChannel(NotificationManager notificationManager) {
        String str = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.notification";
