...
import com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ui.MainActivityBase;
import com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.ui.SplashActivityBase;
import com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.utils.TimeUtils;

public class NotificationHandler {
    private static final String CHANNEL_ID = "com.apphubstudio.sleepingmusic.rainsounds.relaxmusic.whitenoises.Notification";
    ...
    public static void buildNotification(SoundPlayerService soundPlayerService) {
        ...
        Intent intent = new Intent(soundPlayerService, MainActivityBase.class);
        ...
        if (soundPlayerService.getSoundPlayerManager().getMixItem() != null) {
            remoteViews.setTextViewText(R.id.sound_name, soundPlayerService.getSoundPlayerManager().getMixItem().getmName());
        }
    ...
    public static void buildBedNotification(Context context) {
        ...
        Intent intent = new Intent(context, SplashActivityBase.class);
        intent.addFlags(67108864);
