...
public class AlarmUtils {
    ...
    public static void setBedAlarm(Context context, long j) {
        ...
        if (i >= 21) {
            ...
            if (timeInMillis > 0) {
                ComponentName componentName = new ComponentName(context, ServiceRemind.class);
        ...
        if (alarmManager != null && j > 0) {
            ...
            alarmManager.set(AlarmManager.RTC_WAKEUP, j, PendingIntent.getBroadcast(context, 0, intent, 134217728));
    ...
    public static void createBedNotification(Context context, long j) {
        ...
        notifications.getNotificationManager().notify(2021, notifications.createNotification(remoteViews, activity));
    }
