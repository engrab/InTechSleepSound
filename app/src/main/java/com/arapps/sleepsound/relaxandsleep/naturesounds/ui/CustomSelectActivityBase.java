...
public class CustomSelectActivityBase extends ActivityBase implements OnClickListener {
    ...
    private List<ModelSound> modelSounds;
...
@Override
    public void onClick(View view) {
        ...
        if (id == R.id.ll_close) {
            ...
            startActivity(new Intent(this, SaveCustomActivityBase.class));
            finish();
        }
    }
    ...
    public void SetUpList() {
        ...
        this.slimAdapter = SlimAdapter.create().register(R.layout.model_rcv_selected_sound, new SlimInjector<ModelSound>() {
            public void onInject(final ModelSound modelSound, final IViewInjector iViewInjector) {
                iViewInjector.image(R.id.iv_sound_icon, modelSound.getmResId());
                iViewInjector.text(R.id.tv_sound_name, modelSound.getmStrName());
                iViewInjector.clicked(R.id.iv_delete_sound, new OnClickListener() {
                    public void onClick(View view) {
                        Intent intent = new Intent(CustomSelectActivityBase.this, SoundPlayerService.class);
                        ...
                        CustomSelectActivityBase.this.startService(intent);
                        CustomSelectActivityBase.this.modelSounds.remove(modelSound);
                        CustomSelectActivityBase.this.slimAdapter.updateData(CustomSelectActivityBase.this.modelSounds);
                        CustomSelectActivityBase.this.slimAdapter.notifyDataSetChanged();
                        if (CustomSelectActivityBase.this.modelSounds.size() == 0) {
                            CustomSelectActivityBase.this.finish();
                        }
                    }
                });
                            ...
                            public void onProgressChanged(final SeekBar seekBar, int i, boolean z) {
                                iViewInjector.with(R.id.seek_bar_sound_volume, new Action<AppCompatSeekBar>() {
                                    public void action(AppCompatSeekBar appCompatSeekBar) {
                                        ...
                                        SoundPlayerManager.getInstance(CustomSelectActivityBase.this).setVolume(modelSound, (float) appCompatSeekBar.getProgress());
        ...
        this.modelSounds = SoundPlayerManager.getInstance(this).getPlayingSoundItem();
        this.slimAdapter.updateData(this.modelSounds);
    }
}
