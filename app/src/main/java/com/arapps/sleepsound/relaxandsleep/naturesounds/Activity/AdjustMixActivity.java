...
public class AdjustMixActivity extends BaseActivity implements OnClickListener {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getIntExtra(SoundPlayerService.RESULT_CODE, 0) == 1) {
                ...
                if (intExtra == 0) {
                    ...
                    AdjustMixActivity.this.mSlimAdapter.notifyDataSetChanged();
                } else if (intExtra == 2) {
                    AdjustMixActivity.this.mMixSoundControlIv.setImageResource(R.drawable.vector_ic_play);
                    AdjustMixActivity.this.PauseAnim();
                    AdjustMixActivity.this.PlayAnim();
    ...
    public List<MixModel> filter(int i) {
        ...
        for (MixModel mixModel : SoundListDataSource.getListMixItem(this)) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AdsUtils.ShowBanner(AdjustMixActivity.this, relativeLayout);

        this.mMixModel = SoundPlayerManager.getInstance(this).getMixItem();
        InitView();
    ...
    public void SetUpList() {
        ...
        this.mSlimAdapter = SlimAdapter.create().register(R.layout.model_mix, new SlimInjector<MixModel>() {
            public void onInject(final MixModel mixModel, IViewInjector iViewInjector) {
                ...
                iViewInjector.with(R.id.cover_image, new Action<ImageView>() {
                    public void action(ImageView simpleDraweeView) {
                        simpleDraweeView.setImageURI(Utils.getUriToResource(AdjustMixActivity.this, mixModel.getMixSoundCover().getCoverResId()));
                    }
                });
                iViewInjector.invisible(R.id.ads_icon);
                iViewInjector.clicked(R.id.cover_container, new OnClickListener() {
                    public void onClick(View view) {
                        Intent intent = new Intent(AdjustMixActivity.this, SoundPlayerService.class);
                        ...
                        AdjustMixActivity.this.mMixModel = mixModel;
                        AdjustMixActivity.this.UpdateUI();
                        AdjustMixActivity.this.mMixSoundControlIv.setImageResource(R.drawable.vector_ic_pause);
                    }
                });
                if (SoundPlayerManager.getInstance(AdjustMixActivity.this).getPlayerState() == 2) {
                    iViewInjector.visibility(R.id.view_play_state_bg, 0);
                    iViewInjector.image(R.id.iv_play_state, R.drawable.vector_ic_play);
                } else if (AdjustMixActivity.this.mMixModel.getMixSoundId() == mixModel.getMixSoundId()) {
                    iViewInjector.visibility(R.id.view_play_state_bg, 0);
        ...
        this.mixModels = SoundListDataSource.getListMixItem(this);
        this.mSlimAdapter.updateData(this.mixModels);
    }
    ...
    private void InitView() {
        ...
        mToolbar.setNavigationOnClickListener(view -> AdjustMixActivity.this.finish());
    ...
    public void UpdateUI() {
        ...
        this.mSlimAdapter.notifyDataSetChanged();
        this.mMixSoundNameTv.setText(this.mMixModel.getName());
        this.mMixSoundCoverIv.setImageResource(this.mMixModel.getMixSoundCover().getCoverResId());
        this.mPlayBgIv.setImageResource(this.mMixModel.getMixSoundCover().getBigCoverResId());
        this.mSlimAdapter.notifyDataSetChanged();
    }
